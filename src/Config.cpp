...
const std::unordered_map<std::string, ConfigItem> k_config_key_table = {
  ...
  {"filecache_url", ConfigItem::filecache_url},
  ...
  {"mysqlcache_url", ConfigItem::mysqlcache_url},
...
Config::get_string_value(const std::string& key) const
{
  ...
  case ConfigItem::mysqlcache_url:
    return m_mysqlcache_url;
                 ...
                 const std::string& origin)
{
  ...
  case ConfigItem::filecache_url:
    m_filecache_url = Util::expand_environment_variables(value);
    break;
  ...
  case ConfigItem::mysqlcache_url:
    m_mysqlcache_url = Util::expand_environment_variables(value);
    break;
